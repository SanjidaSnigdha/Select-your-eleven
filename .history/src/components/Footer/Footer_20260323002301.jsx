...
const Footer = () => {
    return (
        <footer className="footer sm:footer-horizontal bg-[#040D11] text-base-content p-10 mt-10 w-full h-[300px] flex flex-col-3">
            <div className='items-center justify-center w-2/12 mx-auto'>
            <img src={footerImg} alt="" className='w-20 h-20 items-center justify-center w-2/12 mx-auto'/>
            </div>
   <div className='mt-10'>
