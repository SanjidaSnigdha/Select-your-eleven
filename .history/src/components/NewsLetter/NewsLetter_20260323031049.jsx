...
const NewsLetter = () => {
    return (
        <div className='w-[980px] h-[280px] rounded-2xl bg-gradient-to-r from-blue-100 via-white-100 to-pink-100 -mt-80 mx-auto items-center text-center p-8 relative'>
