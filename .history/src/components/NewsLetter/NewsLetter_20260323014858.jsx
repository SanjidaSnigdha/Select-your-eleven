...
const NewsLetter = () => {
    return (
        <div className='w-[980px] h-[280px] rounded-2xl bg-gradient-to-r from-blue-100 via-white-100 to-pink-200 absolute -bottom-665 left-1/2 transform -translate-x-1/2 z-10 mt-8'>
