...
const Banner = () => {
    return (
        <div className='max-w-[1200px] mx-auto h-[535px] bg-[#131313]/90 mt-8 mb-10 rounded-3xl'>
           ...
           <div>
            ...
            <button className='btn flex mt-5 rounded-xl bg-[#E7FE29] w-2/12 mx-auto text-center items-center'>Claim Free Credit</button>
           </div>
        </div>
