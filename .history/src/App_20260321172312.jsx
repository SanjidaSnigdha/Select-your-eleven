...
function App() {
  ...
  return (
   ...
   <div className='max-w-[1200px] mx-auto flex justify-between items-center'>
    ...
    <AvailablePlayers purchasedPlayers={purchasedPlayers} availableBalance={availableBalance} setAvailableBalance={setAvailableBalance} playersPromise={playersPromise}></AvailablePlayers>
